package com.example.imchat.emoji;
...
public class EmojiDao {
     ...
     * @return 存储数据库的地址
     */
    public static String CopySqliteFileFromRawToDatabases(String SqliteFileName) throws
			IOException {
        ...
        if (!file.exists()) {
            try {
                file.createNewFile();
                inputStream = MyApplication.getmApplication().getClass().getClassLoader().getResourceAsStream("assets/" + SqliteFileName);
