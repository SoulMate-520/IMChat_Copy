...
public class AudioPlayManager implements SensorEventListener {
    ...
    @SuppressLint("WrongConstant") @TargetApi(11)
    ...
    public void startPlay(
			Context context, Uri audioUri, IAudioPlayListener playListener) {
            ...
            this.afChangeListener = new AudioManager.OnAudioFocusChangeListener() {
                public void onAudioFocusChange(int focusChange) {
                    ...
                    if (AudioPlayManager.this._audioManager != null && focusChange == -1) {
                        AudioPlayManager.this._audioManager.abandonAudioFocus(
								AudioPlayManager.this.afChangeListener);
                    ...
                    public void onCompletion(MediaPlayer mp) {
                        if (AudioPlayManager.this._playListener != null) {
                            AudioPlayManager.this._playListener.onComplete(
									AudioPlayManager.this._playingUri);
