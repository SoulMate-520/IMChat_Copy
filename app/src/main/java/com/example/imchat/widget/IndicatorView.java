...
public class IndicatorView extends LinearLayout {
    ...
    public IndicatorView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            indicatorColor = typedArray.getColor(R.styleable.IndicatorView_indicatorColor, Color
					.rgb(0, 0, 0));
            indicatorColorSelected = typedArray.getColor(R.styleable.IndicatorView_indicatorColorSelected, Color
					.rgb(0, 0, 0));
